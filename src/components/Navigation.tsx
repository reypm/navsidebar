            ...
            {items.length > 0 && (
                ...
                >
                    {items.map((item: NavItemProps) => {
                        ...
                        const isActiveTab: boolean = activeSubNav.expanded &&
                            ...
                            <ul key={item.itemId} className="side-navigation-panel-select">
                                <li className="side-navigation-panel-select-wrap">
                                    <div
                                        ...
                                        className={`side-navigation-panel-select-option ${isItemSelected ? 'side-navigation-panel-select-option-selected' : ''}`}
                                    >
                                        <span className="side-navigation-panel-select-option-wrap">
                                            <a href={item.itemId} className="side-navigation-panel-select-option-text">
                                            {item.title}
                                            </a>
                                        </span>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <span className="side-navigation-panel-select-inner-option-wrap">
                                                            <a href={subNavItem.itemId} className="side-navigation-panel-select-inner-option-text">
                                                                {subNavItem.title}
                                                            </a>
                                                        </span>
                                                    </div>
